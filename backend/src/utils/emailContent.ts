export const emailContent = (code: number, path: string, firstName: string) => {
...
the following <b> verification code: </b> ${code}. If you don't want to create an account, you can ignore this message.
</p>`
    : `<h2>Password Reset</h2> <p>Hi <b>${firstName}</b>, If you've lost your password or wish to reset it, use this <b>code
below </b> <br> ${code}  . If you did not request a password reset, you can safely ignore this email. Only a person with access 
